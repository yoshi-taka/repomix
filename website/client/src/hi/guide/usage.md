...
### विशिष्ट फाइलों के साथ पूर्ण डायरेक्टरी संरचना शामिल करना

`--include` पैटर्न का उपयोग करते समय, आप केवल चयनित फाइलों को प्रोसेस करते हुए पूर्ण डायरेक्टरी ट्री संरचना भी प्रदर्शित कर सकते हैं:

```bash
repomix --include "cli/**/*.go" --include-full-directory-structure
```

यह फ्लैग डायरेक्टरी संरचना सेक्शन में सभी डायरेक्टरी और फाइलों (ignore पैटर्न का सम्मान करते हुए) को दिखाकर पूर्ण रिपॉजिटरी संदर्भ प्रदान करता है, जबकि केवल उन फाइलों को प्रोसेस करता है जो include पैटर्न से मेल खाती हैं।

**लाभ:**
- **पूर्ण प्रोजेक्ट संदर्भ**: include पैटर्न के बाहर की फाइलों सहित पूरी डायरेक्टरी संरचना देखें
- **केंद्रित प्रोसेसिंग**: फाइल सामग्री और मेट्रिक्स अभी भी केवल शामिल की गई फाइलों को दर्शाते हैं
- **बेहतर AI समझ**: बेहतर संदर्भ के लिए पूर्ण रिपॉजिटरी लेआउट प्रदान करता है
...
`--include-full-directory-structure` के साथ:
```
<directory_structure>
README.md
LICENSE.md
...
**नोट:** यह फ्लैग केवल डायरेक्टरी संरचना विज़ुअलाइज़ेशन को प्रभावित करता है। फाइल प्रोसेसिंग, सामग्री और मेट्रिक्स आपके include पैटर्न तक सीमित रहते हैं।
